...
defmodule Day4Test do
  ...
  test "part 1 example 1" do
    assert 123 = Day4.real_room_checksum("aaaaa-bbb-z-y-x-123[abxyz]")
    assert 987 = Day4.real_room_checksum("a-b-c-d-e-f-g-h-987[abcde]")
    assert 404 = Day4.real_room_checksum("not-a-real-room-404[oarel]")
    assert   0 = Day4.real_room_checksum("totally-real-room-200[decoy]")
